<div class="flex flex-row pt-10 pb-10 bg-violet-900 justify-center sm:justify-between">
  ...
  <div class="sm:mx-6 mx-2">
    ...
    <a href="https://www.github.com/benwittbrodt" target="_blank"><i class="fab fa-github text-white text-4xl m-1 hover:text-slate-400 ease-in-out duration-200"></i></a>
  </div>
</div>
