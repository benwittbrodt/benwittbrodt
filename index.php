    ...
    <div class="column-4 w-col w-col-6 w-col-medium-6">
      <div class="index-div">
        ...
        <div class="w-row margin">
          <a href="<?php echo site_url('background'); ?>"><button class="index-button">Professional Background</button></a>
          <a href="<?php echo site_url('projects') ?>"><button class="index-button">Design Projects</button></a>
        </div>
        <div class="div-40">
